...
export function FeaturedProject({ project }: { project: Project }) {
  ...
  return (
    <TerminalWindow title="cat — destacado.md" className="card-lift group">
      <div className="relative grid gap-8 p-7 sm:p-9 lg:grid-cols-[minmax(0,1fr)_330px] lg:gap-11">
